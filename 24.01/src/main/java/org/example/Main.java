...
public class Main {
    private static final EntityManagerFactory emf = Persistence.createEntityManagerFactory("progetto-24");
...
//Elemento rivista3 = new Rivista("Cio̬",2011,40,Periodicita.SETTIMANALE);
